...
public class PersistentLoginsRecord extends UpdatableRecordImpl<PersistentLoginsRecord> implements Record4<String, String, String, Timestamp> {
    ...
    private static final long serialVersionUID = 356748591;

    /**
     * Setter for <code>DMS.PERSISTENT_LOGINS.USERNAME</code>.
     */
    ...
    /**
     * Getter for <code>DMS.PERSISTENT_LOGINS.USERNAME</code>.
     */
    @NotNull
    @Size(max = 64)
    ...
    /**
     * Setter for <code>DMS.PERSISTENT_LOGINS.SERIES</code>.
     */
    ...
    /**
     * Getter for <code>DMS.PERSISTENT_LOGINS.SERIES</code>.
     */
    @NotNull
    @Size(max = 64)
    ...
    /**
     * Setter for <code>DMS.PERSISTENT_LOGINS.TOKEN</code>.
     */
    ...
    /**
     * Getter for <code>DMS.PERSISTENT_LOGINS.TOKEN</code>.
     */
    @NotNull
    @Size(max = 64)
    ...
    /**
     * Setter for <code>DMS.PERSISTENT_LOGINS.LAST_USED</code>.
     */
    ...
    /**
     * Getter for <code>DMS.PERSISTENT_LOGINS.LAST_USED</code>.
     */
    @NotNull

...
@Repository
public class AcademicTitleDao extends DAOImpl<AcademicTitleRecord, top.zbeboy.dms.domain.dms.tables.pojos.AcademicTitle, Integer> {

    /**
     * Create a new AcademicTitleDao without any configuration
     */
    public AcademicTitleDao() {
        super(AcademicTitle.ACADEMIC_TITLE, top.zbeboy.dms.domain.dms.tables.pojos.AcademicTitle.class);
    }
    ...
    public AcademicTitleDao(Configuration configuration) {
        super(AcademicTitle.ACADEMIC_TITLE, top.zbeboy.dms.domain.dms.tables.pojos.AcademicTitle.class, configuration);
    }
     ...
     */
    @Override
    protected Integer getId(top.zbeboy.dms.domain.dms.tables.pojos.AcademicTitle object) {
     ...
     */
    public List<top.zbeboy.dms.domain.dms.tables.pojos.AcademicTitle> fetchByAcademicTitleId(Integer... values) {
     ...
     */
    public top.zbeboy.dms.domain.dms.tables.pojos.AcademicTitle fetchOneByAcademicTitleId(Integer value) {
     ...
     */
    public List<top.zbeboy.dms.domain.dms.tables.pojos.AcademicTitle> fetchByAcademicTitleName(String... values) {

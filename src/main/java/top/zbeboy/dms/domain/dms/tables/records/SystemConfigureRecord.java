...
public class SystemConfigureRecord extends UpdatableRecordImpl<SystemConfigureRecord> implements Record2<String, String> {
    ...
    private static final long serialVersionUID = 121156883;

    /**
     * Setter for <code>DMS.SYSTEM_CONFIGURE.DATA_KEY</code>.
     */
    ...
    /**
     * Getter for <code>DMS.SYSTEM_CONFIGURE.DATA_KEY</code>.
     */
    @NotNull
    @Size(max = 50)
    ...
    /**
     * Setter for <code>DMS.SYSTEM_CONFIGURE.DATA_VALUE</code>.
     */
    ...
    /**
     * Getter for <code>DMS.SYSTEM_CONFIGURE.DATA_VALUE</code>.
     */
    @Size(max = 100)

...
public class DepartmentRecord extends UpdatableRecordImpl<DepartmentRecord> implements Record4<Integer, String, Integer, Boolean> {

    private static final long serialVersionUID = -351634874;
    ...
    /**
     * Setter for <code>DMS.DEPARTMENT.DEPARTMENT_IS_DEL</code>.
     */
    public void setDepartmentIsDel(Boolean value) {
        set(3, value);
    }

    /**
     * Getter for <code>DMS.DEPARTMENT.DEPARTMENT_IS_DEL</code>.
     */
     ...
     */
    @Override
    public DepartmentRecord value4(Boolean value) {
     ...
     */
    @Override
    public DepartmentRecord values(Integer value1, String value2, Integer value3, Boolean value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DepartmentRecord(Integer departmentId, String departmentName, Integer collegeId, Boolean departmentIsDel) {
        super(Department.DEPARTMENT);

        set(0, departmentId);
        set(1, departmentName);
        set(2, collegeId);
        set(3, departmentIsDel);
    }
}

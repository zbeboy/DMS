...
public class Indexes {
    ...
    private static class Indexes0 {
        public static Index PRIMARY_KEY_D = Internal.createIndex("PRIMARY_KEY_D", AcademicTitle.ACADEMIC_TITLE, new OrderField[] { AcademicTitle.ACADEMIC_TITLE.ACADEMIC_TITLE_ID }, true);
        ...
        public static Index PRIMARY_KEY_8 = Internal.createIndex("PRIMARY_KEY_8", Nation.NATION, new OrderField[] { Nation.NATION.NATION_ID }, true);
        ...
        public static Index PRIMARY_KEY_D6 = Internal.createIndex("PRIMARY_KEY_D6", SystemConfigure.SYSTEM_CONFIGURE, new OrderField[] { SystemConfigure.SYSTEM_CONFIGURE.DATA_KEY }, true);

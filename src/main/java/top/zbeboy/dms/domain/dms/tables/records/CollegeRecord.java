...
public class CollegeRecord extends UpdatableRecordImpl<CollegeRecord> implements Record5<Integer, String, String, Integer, Boolean> {

    private static final long serialVersionUID = 556805313;
    ...
    /**
     * Setter for <code>DMS.COLLEGE.COLLEGE_IS_DEL</code>.
     */
    public void setCollegeIsDel(Boolean value) {
        set(4, value);
    }

    /**
     * Getter for <code>DMS.COLLEGE.COLLEGE_IS_DEL</code>.
     */
     ...
     */
    @Override
    public CollegeRecord value5(Boolean value) {
     ...
     */
    @Override
    public CollegeRecord values(Integer value1, String value2, String value3, Integer value4, Boolean value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CollegeRecord(Integer collegeId, String collegeName, String collegeAddress, Integer schoolId, Boolean collegeIsDel) {
        super(College.COLLEGE);

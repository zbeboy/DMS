...
@Repository
public class DepartmentDao extends DAOImpl<DepartmentRecord, top.zbeboy.dms.domain.dms.tables.pojos.Department, Integer> {

    /**
     * Create a new DepartmentDao without any configuration
     */
    public DepartmentDao() {
        super(Department.DEPARTMENT, top.zbeboy.dms.domain.dms.tables.pojos.Department.class);
    }
    ...
    public DepartmentDao(Configuration configuration) {
        super(Department.DEPARTMENT, top.zbeboy.dms.domain.dms.tables.pojos.Department.class, configuration);
    }
     ...
     */
    @Override
    protected Integer getId(top.zbeboy.dms.domain.dms.tables.pojos.Department object) {
     ...
     */
    public List<top.zbeboy.dms.domain.dms.tables.pojos.Department> fetchByDepartmentId(Integer... values) {
     ...
     */
    public top.zbeboy.dms.domain.dms.tables.pojos.Department fetchOneByDepartmentId(Integer value) {
     ...
     */
    public List<top.zbeboy.dms.domain.dms.tables.pojos.Department> fetchByDepartmentName(String... values) {

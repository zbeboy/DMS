...
public class AuthoritiesRecord extends UpdatableRecordImpl<AuthoritiesRecord> implements Record2<String, String> {
    ...
    private static final long serialVersionUID = -1139537074;

    /**
     * Setter for <code>DMS.AUTHORITIES.USERNAME</code>.
     */
    ...
    /**
     * Getter for <code>DMS.AUTHORITIES.USERNAME</code>.
     */
    @NotNull
    @Size(max = 64)
    ...
    /**
     * Setter for <code>DMS.AUTHORITIES.AUTHORITY</code>.
     */
    ...
    /**
     * Getter for <code>DMS.AUTHORITIES.AUTHORITY</code>.
     */
    @NotNull
    @Size(max = 50)
